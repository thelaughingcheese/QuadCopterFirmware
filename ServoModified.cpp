...
uint8_t ServoModified::attach(int pin)
{
	return this->attach(pin,MIN_PULSE_WIDTH,MAX_PULSE_WIDTH);
}

uint8_t ServoModified::attach(int pin,int min,int max)
{
...
void ServoModified::write(int value)
{
...
void ServoModified::writeMicroseconds(int value)
{
...
int ServoModified::read() // return the value as degrees
{
	return  map(this->readMicroseconds()+1,SERVO_MIN(),SERVO_MAX(),0,180);
}

int ServoModified::readMicroseconds()
{
...
uint8_t ServoModified::attach(int pin,int minimum,int maximum)
{
